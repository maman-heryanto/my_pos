        ...
        <div class="col-md-10">
            <div class="main-card">
                <div class="card-header-gradient">
                    <h4 class="mb-0 font-weight-bold"><i class="fas fa-box-open mr-2"></i> Tambah Produk Baru</h4>
                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="code" class="form-control form-control-lg-custom border-left-0" style="border-radius: 0 12px 12px 0;" placeholder="Kode unik" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control form-control-lg-custom border-left-0" style="border-radius: 0 12px 12px 0;" placeholder="Contoh: Beras Premium 5kg" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="1" name="price" class="form-control form-control-lg-custom border-left-0" style="border-radius: 0 12px 12px 0;" placeholder="0" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group mb-4">
                                    <label class="font-weight-bold text-muted">Stok Awal <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" inputmode="decimal" pattern="[0-9]*[.,]?[0-9]*" name="stock" class="form-control form-control-lg-custom border-left-0" style="border-radius: 0 12px 12px 0;" placeholder="0" required>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="unit" class="form-control form-control-lg-custom border-left-0" style="border-radius: 0 12px 12px 0;" placeholder="Contoh: kg, pcs, sak" value="kg" required>
                                    </div>
                                </div>
                            </div>
                        </div>
