        ...
        <div class="col-md-8">
            <div class="main-card">
                <div class="card-header-gradient">
                    <h4 class="mb-0 font-weight-bold"><i class="fas fa-user-plus mr-2"></i> Tambah Pelanggan Baru</h4>
                </div>
                    ...
                    <form action="{{ route('customers.store') }}" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" class="form-control form-control-lg-custom border-left-0" style="border-radius: 0 12px 12px 0;" placeholder="Masukkan nama pelanggan" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-5">
                            ...
                            <div class="input-group">
                                ...
                                <textarea name="address" class="form-control form-control-lg-custom border-left-0" style="border-radius: 0 12px 12px 0; height: 100px; padding-top: 15px;" placeholder="Masukkan alamat lengkap pelanggan"></textarea>
                            </div>
                        </div>
